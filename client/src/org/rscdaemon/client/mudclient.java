...
public final class mudclient extends GameWindowMiddleMan {
  ...
  private static String towns[] = { "Varrock", "Edgeville", "Barbarian Village", "Draynor", "Lumbridge", "Al Kharid",
      "Falador", "Port Sarim", "Taverly", "Entrana", "Catherby", "Seers", "Gnome Stronghold", "Ardougne", "Yanille",
      "Brimhaven", "Karamja", "Shilo Village" };
  private static int coords[][] = { { 50, 180, 444, 565 }, { 180, 245, 427, 472 }, { 180, 245, 472, 535 },
      { 180, 245, 535, 715 }, { 104, 180, 633, 710 }, { 47, 94, 578, 733 }, { 245, 338, 510, 608 },
      { 245, 355, 608, 693 }, { 338, 384, 430, 576 }, { 395, 441, 525, 573 }, { 399, 477, 476, 513 },
      { 477, 592, 432, 485 }, { 673, 751, 432, 537 }, { 500, 708, 537, 640 }, { 528, 671, 712, 785 },
      { 435, 522, 640, 710 }, { 333, 435, 679, 710 }, { 384, 431, 815, 860 } };
  private String lastMessage = "";
  private int fatigue;
  private int druidicritualcomplete, impcatchercomplete, cooksassistantcomplete, romeojuliet, sheepshearer, witchpotion,
      doricsquest;
  ...
  public static String Clientname = "Wolf Kingdom";
  ...
  private boolean handleCommand(String s) {
    ...
    if (ourPlayer.admin >= 2 && cmd.equals("staff")) {
      ...
      try {
        ...
        if (showTradeWindow) {
          ...
          if (inventoryCount(id) < amount) {
            displayMessage("@cya@You do not have that many" + EntityHandler.getItemDef(id).getName() + " to offer", 3,
                0);
            return true;
          }
            ...
            if (tradeMyItems[c] == id) {
              if (EntityHandler.getItemDef(id).isStackable()) {
                if (inventoryCount(id) < (tradeMyItemsCount[c] + amount)) {
                  displayMessage(
                      "@cya@You do not have that many" + EntityHandler.getItemDef(id).getName() + " to offer", 3, 0);
                  return true;
                }
  ...
  final void method45(int i, int j, int k, int l, int i1, int j1, int k1) {
    ...
    for (int k2 = 0; k2 < 12; k2++) {
      ...
      if (k3 >= 0) {
        ...
        if (i2 != 5 || EntityHandler.getAnimationDef(k3).hasA()) {
          ...
          int i5 = (k * ((GameImage) (gameGraphics)).sprites[l4].getSomething1())
              / ((GameImage) (gameGraphics)).sprites[EntityHandler.getAnimationDef(k3).getNumber()].getSomething1();
          i4 -= (i5 - k) / 2;
    ...
    if (mob.lastMessageTimeout > 0) {
      ...
      mobMessagesHeight[mobMessageCount] = (gameGraphics.textWidth(mob.lastMessage, 1) / 300)
  ...
  private final void drawCharacterLookScreen() {
    ...
    if (characterDesignMenu.hasActivated(characterDesignHeadButton1))
      ...
      while ((EntityHandler.getAnimationDef(characterHeadType).getGenderModel() & 3) != 1
          || (EntityHandler.getAnimationDef(characterHeadType).getGenderModel() & 4 * characterHeadGender) == 0);
    ...
    for (int k2 = 0; k2 < 12; k2++) {
      ...
      if (l3 >= 0) {
        ...
        if (i2 != 5 || EntityHandler.getAnimationDef(l3).hasA()) {
          ...
          int l5 = (k * ((GameImage) (gameGraphics)).sprites[k5].getSomething1())
              / ((GameImage) (gameGraphics)).sprites[EntityHandler.getAnimationDef(l3).getNumber()].getSomething1();
          k4 -= (l5 - k) / 2;
  ...
  private final void loadModels() {
    ...
    String[] modelNames = { "torcha2", "torcha3", "torcha4", "skulltorcha2", "skulltorcha3", "skulltorcha4", "firea2",
        "firea3", "fireplacea2", "fireplacea3", "firespell2", "firespell3", "lightning2", "lightning3", "clawspell2",
  ...
  protected final void method4() {
    if (lastLoadedNull) {
      ...
      int i = 35;
      g.drawString("Sorry, an error has occured whilst loading Wolf Kingdom", 30, i);
      i += 50;
    ...
    if (memoryError) {
      ...
      g2.drawString("Wolf Kingdom needs about 100mb of spare RAM", 50, 200);
      changeThreadSleepModifier(1);
      return;
    }
    try {
    ...
    if (mouseButtonClick != 0) {
      ...
      if (i >= 0 && k >= 12 && i < 408 && k < 280) {
        ...
        if (k2 != -1) {
          ...
          // j1 = 1;
          if (j1 >= 1 && super.mouseX >= i + 220 && super.mouseY >= k + 238 && super.mouseX < i + 250
              && super.mouseY <= k + 249) {
          ...
          if (j1 >= 10 && super.mouseX >= i + 250 && super.mouseY >= k + 238 && super.mouseX < i + 280
              && super.mouseY <= k + 249) {
            super.streamClass.createPacket(183);
            super.streamClass.add2ByteInt(k2);
          ...
          if (j1 >= 100 && super.mouseX >= i + 280 && super.mouseY >= k + 238 && super.mouseX < i + 305
              && super.mouseY <= k + 249) {
            super.streamClass.createPacket(183);
            super.streamClass.add2ByteInt(k2);
          ...
          if (j1 >= 1000 && super.mouseX >= i + 305 && super.mouseY >= k + 238 && super.mouseX < i + 335
              && super.mouseY <= k + 249) {
            super.streamClass.createPacket(183);
            super.streamClass.add2ByteInt(k2);
          ...
          if (j1 >= 10000 && super.mouseX >= i + 335 && super.mouseY >= k + 238 && super.mouseX < i + 368
              && super.mouseY <= k + 249) {
            super.streamClass.createPacket(183);
            super.streamClass.add2ByteInt(k2);
          ...
          if (inventoryCount(k2) >= 1 && super.mouseX >= i + 220 && super.mouseY >= k + 263 && super.mouseX < i + 250
              && super.mouseY <= k + 274) {
          ...
          if (inventoryCount(k2) >= 10 && super.mouseX >= i + 250 && super.mouseY >= k + 263 && super.mouseX < i + 280
              && super.mouseY <= k + 274) {
            super.streamClass.createPacket(198);
            super.streamClass.add2ByteInt(k2);
            super.streamClass.add4ByteInt(10);
          ...
          if (inventoryCount(k2) >= 100 && super.mouseX >= i + 280 && super.mouseY >= k + 263 && super.mouseX < i + 305
              && super.mouseY <= k + 274) {
            super.streamClass.createPacket(198);
            super.streamClass.add2ByteInt(k2);
            super.streamClass.add4ByteInt(100);
          ...
          if (inventoryCount(k2) >= 1000 && super.mouseX >= i + 305 && super.mouseY >= k + 263 && super.mouseX < i + 335
              && super.mouseY <= k + 274) {
            super.streamClass.createPacket(198);
            super.streamClass.add2ByteInt(k2);
            super.streamClass.add4ByteInt(1000);
          ...
          if (inventoryCount(k2) >= 10000 && super.mouseX >= i + 335 && super.mouseY >= k + 263
              && super.mouseX < i + 368 && super.mouseY <= k + 274) {
            super.streamClass.createPacket(198);
            super.streamClass.add2ByteInt(k2);
            super.streamClass.add4ByteInt(10000);
            super.streamClass.formatPacket();
  ...
  private final void drawChatMessageTabs() {
    ...
    if (anInt956 % 30 > 15)
      i = GameImage.convertRGBToLong(255, 50, 50);
    gameGraphics.drawText("Say/Clan History", 457, windowHeight + 6, 0, i);
    i = GameImage.convertRGBToLong(200, 200, 255);
  }
  ...
  private final void method62() {
    ...
    gameGraphics.spriteClip4(i - 32 - 55, j, 64, 102, EntityHandler.getAnimationDef(characterBodyGender).getNumber(),
    ...
    gameGraphics.spriteClip4((i - 32) + 55, j, 64, 102,
        ...
        characterTopBottomColours[characterTopColour], characterSkinColours[characterSkinColour], 0, false);
    gameGraphics.spriteClip4((i - 32) + 55, j, 64, 102,
        EntityHandler.getAnimationDef(characterHeadType).getNumber() + 12, characterHairColours[characterHairColour],
  ...
  private final void drawPlayerInfoMenu(boolean flag) {
    ...
    gameGraphics.drawText("Combat", i + c / 7 + c / 3 + c / 3 + 2, j + 16, 4, 0);
    if (anInt826 == 0) {
      int i1 = 72;
      int k1 = -1;
      ...
      for (int l1 = 0; l1 < 9; l1++) {
        ...
        gameGraphics.drawString(skillArray[l1] + ":@yel@" + playerStatCurrent[l1] + "/" + playerStatBase[l1], i + 5, i1,
            1, i2);
        i2 = 0xffffff;
        ...
        gameGraphics.drawString(
            skillArray[l1 + 9] + ":@yel@" + playerStatCurrent[l1 + 9] + "/" + playerStatBase[l1 + 9], (i + c / 2) - 5,
            i1, 1, i2);
        i1 += 13;
      }
      gameGraphics.drawString("Quest Points: @yel@" + questpoints, (i + c / 2) - 5, i1, 3, 0xffffff);
      i1 += 13;
      ...
      for (int j2 = 0; j2 < 3; j2++) {
        ...
        gameGraphics.drawString(equipmentStatusName[j2 + 3] + ":@yel@" + equipmentStatus[j2 + 3], i + c / 2 + 25, i1, 1,
            0xffffff);
        i1 += 13;
      }
      ...
      if (k1 != -1) {
        ...
        int maxHit = (int) (str * ((double) equipmentStatus[2] * 0.00175D + 0.10000000000000001D)
            + 2.0499999999999998D);
    ...
    if (anInt826 == 1) {
      int i1 = 72; // Quest info
      gameGraphics.drawString("@whi@Quest-list (green=completed)", i + 5, i1, 3, 0xffff00);
      i1 += 13;
      if (druidicritualcomplete == 1) {
        gameGraphics.drawString("@gre@Druidic Ritual", i + 5, i1, 1, 0xffffff);
      } else {
        gameGraphics.drawString("@red@Druidic Ritual", i + 5, i1, 1, 0xffffff);
      }
      i1 += 13;
      if (impcatchercomplete == 1) {
        gameGraphics.drawString("@gre@Imp Catcher", i + 5, i1, 1, 0xffffff);
      } else {
        gameGraphics.drawString("@red@Imp Catcher", i + 5, i1, 1, 0xffffff);
      }
      i1 += 13;
      if (cooksassistantcomplete == 1) {
        gameGraphics.drawString("@gre@Cook's Assistant", i + 5, i1, 1, 0xffffff);
      } else {
        gameGraphics.drawString("@red@Cook's Assistant", i + 5, i1, 1, 0xffffff);
      }
      i1 += 13;
      if (sheepshearer == 1) {
        gameGraphics.drawString("@gre@Sheep Shearer", i + 5, i1, 1, 0xffffff);
      } else {
        gameGraphics.drawString("@red@Sheep Shearer", i + 5, i1, 1, 0xffffff);
      }
      i1 += 13;
      if (witchpotion == 1) {
        gameGraphics.drawString("@gre@Witch's Potion", i + 5, i1, 1, 0xffffff);
      } else {
        gameGraphics.drawString("@red@Witch's Potion", i + 5, i1, 1, 0xffffff);
      }
      i1 += 13;
      if (romeojuliet == 1) {
        gameGraphics.drawString("@gre@Romeo & Juliet", i + 5, i1, 1, 0xffffff);
      } else {
        gameGraphics.drawString("@red@Romeo & Juliet", i + 5, i1, 1, 0xffffff);
      }
      i1 += 13;
      if (doricsquest == 1) {
        gameGraphics.drawString("@gre@Doric's Quest", i + 5, i1, 1, 0xffffff);
      } else {
        gameGraphics.drawString("@red@Doric's Quest", i + 5, i1, 1, 0xffffff);
      }
    }
    if (anInt826 == 2) {
      int i1 = 72; // Combat Information
      gameGraphics.drawString("@whi@Combat Statistics", i + 5, i1, 3, 0xffff00);
      i1 += 13;
      gameGraphics.drawString("@yel@Player Information", i + 5, i1, 3, 0xffff00);
      i1 += 13;
      gameGraphics.drawString("@whi@Username: @or1@" + currentUser, i + 5, i1, 3, 0xffff00);
      i1 += 13;
      if (ourPlayer.admin == 3) {
        gameGraphics.drawString("@whi@Rank: #adm# @or1@Administrator", 318, i1, 3, 0xffffff);
      }
      if (ourPlayer.admin == 2) {
        gameGraphics.drawString("@whi@Rank: #mod# @or1@Moderator", 318, i1, 3, 0xffffff);
      }
      if (ourPlayer.admin == 1) {
        gameGraphics.drawString("@whi@Rank: #pmd# @or1@Player Moderator", 318, i1, 3, 0xffffff);
      }
      if (ourPlayer.admin == 4) {
        gameGraphics.drawString("@whi@Rank: #evt# @or1@Event Team", 318, i1, 3, 0xffffff);
      }
      if (ourPlayer.admin == 0) {
        gameGraphics.drawString("@whi@Rank: @or1@Member", 318, i1, 3, 0xffffff);
      }
      i1 += 26;
      gameGraphics.drawString("@yel@Combat Information", i + 5, i1, 3, 0xffff00);
      i1 += 13;
      ...
      i1 += 26;
      gameGraphics.drawString("@yel@Killing Spree Information", i + 5, i1, 3, 0xffff00);
      i1 += 13;
  ...
  private final void checkMouseOverMenus() {
    if (mouseOverMenu == 0 && super.mouseX >= ((GameImage) (gameGraphics)).menuDefaultWidth - 35 && super.mouseY >= 3
        && super.mouseX < ((GameImage) (gameGraphics)).menuDefaultWidth - 3 && super.mouseY < 35)
      mouseOverMenu = 1;
    if (mouseOverMenu == 0 && super.mouseX >= ((GameImage) (gameGraphics)).menuDefaultWidth - 35 - 33
        && super.mouseY >= 3 && super.mouseX < ((GameImage) (gameGraphics)).menuDefaultWidth - 3 - 33
        && super.mouseY < 35) {
      mouseOverMenu = 2;
      anInt985 = (int) (Math.random() * 13D) - 6;
      anInt986 = (int) (Math.random() * 23D) - 11;
    }
    if (mouseOverMenu == 0 && super.mouseX >= ((GameImage) (gameGraphics)).menuDefaultWidth - 35 - 66
        && super.mouseY >= 3 && super.mouseX < ((GameImage) (gameGraphics)).menuDefaultWidth - 3 - 66
        && super.mouseY < 35)
      mouseOverMenu = 3;
    if (mouseOverMenu == 0 && super.mouseX >= ((GameImage) (gameGraphics)).menuDefaultWidth - 35 - 99
        && super.mouseY >= 3 && super.mouseX < ((GameImage) (gameGraphics)).menuDefaultWidth - 3 - 99
        && super.mouseY < 35)
      mouseOverMenu = 4;
    if (mouseOverMenu == 0 && super.mouseX >= ((GameImage) (gameGraphics)).menuDefaultWidth - 35 - 132
        && super.mouseY >= 3 && super.mouseX < ((GameImage) (gameGraphics)).menuDefaultWidth - 3 - 132
        && super.mouseY < 35)
      mouseOverMenu = 5;
    if (mouseOverMenu == 0 && super.mouseX >= ((GameImage) (gameGraphics)).menuDefaultWidth - 35 - 165
        && super.mouseY >= 3 && super.mouseX < ((GameImage) (gameGraphics)).menuDefaultWidth - 3 - 165
        && super.mouseY < 35)
      mouseOverMenu = 6;
    if (mouseOverMenu != 0 && super.mouseX >= ((GameImage) (gameGraphics)).menuDefaultWidth - 35 && super.mouseY >= 3
        && super.mouseX < ((GameImage) (gameGraphics)).menuDefaultWidth - 3 && super.mouseY < 26)
      mouseOverMenu = 1;
    if (mouseOverMenu != 0 && mouseOverMenu != 2
        && super.mouseX >= ((GameImage) (gameGraphics)).menuDefaultWidth - 35 - 33 && super.mouseY >= 3
        && super.mouseX < ((GameImage) (gameGraphics)).menuDefaultWidth - 3 - 33 && super.mouseY < 26) {
      mouseOverMenu = 2;
      anInt985 = (int) (Math.random() * 13D) - 6;
      anInt986 = (int) (Math.random() * 23D) - 11;
    }
    ...
    if (mouseOverMenu != 0 && super.mouseX >= ((GameImage) (gameGraphics)).menuDefaultWidth - 35 - 165
        ...
        && super.mouseY < 26)
      mouseOverMenu = 6;
    if (mouseOverMenu == 1 && (super.mouseX < ((GameImage) (gameGraphics)).menuDefaultWidth - 248
  ...
  private final void menuClick(int index) {
    ...
    if (currentMenuID == 9902) {
      ...
      sendChatString((new StringBuilder()).append("teleport ").append(actionX + areaX).append(" ")
          .append(actionY + areaY).toString());
    }
    ...
    if (currentMenuID == 9915) {
      ...
      for (int i = 0; i < super.friendsCount; i++) {
        if (i == actionType) {
          sendChatString((new StringBuilder()).append("summon ")
              .append(DataOperations.longToString(super.friendsListLongs[i]).replaceAll(" ", "_")).toString());
        }
      }
  ...
  private final void drawGame() {
    ...
    for (int j2 = 0; j2 < groundItemCount; j2++) {
      ...
      gameCamera.method268(40000 + groundItemType[j2], j3,
          -engineHandle.getAveragedElevation(j3, k4) - groundItemObjectVar[j2], k4, 96, 64, j2 + 20000);
      fightCount++;
    }
    ...
    if (cameraAutoAngleDebug) {
      ...
      gameCamera.setCamera(l5, -engineHandle.getAveragedElevation(l5, i8), i8, 912, cameraRotation * 4, 0,
          cameraHeight * 2);
    }
    ...
    if (showInfo) {
      int i9 = 140;
      gameGraphics.drawString((new StringBuilder()).append("@gre@Town: @whi@")
          .append(whereIs(sectionX + areaX, sectionY + areaY)).append("").toString(), 10, i9, 1, 0xffff00);
      i9 += 12;
      gameGraphics.drawString("@gre@Fatigue: @whi@" + fatigue + "%", 10, i9, 1, 0xffffff);
      i9 += 12;
      gameGraphics.drawString("@gre@Exp Gained: @whi@" + (expGained > 1000 ? (expGained / 1000) + "k" : expGained), 10,
          i9, 1, 0xffffff);
      i9 += 12;
      if (combatStyle == 0)
  ...
  private final void drawQuestionMenu() {
    if (mouseButtonClick != 0) {
      for (int i = 0; i < questionMenuCount; i++) {
        if (super.mouseX >= gameGraphics.textWidth(questionMenuAnswer[i], 1) || super.mouseY <= i * 12
    ...
    for (int j = 0; j < questionMenuCount; j++) {
      int k = 65535;
      if (super.mouseX < gameGraphics.textWidth(questionMenuAnswer[j], 1) && super.mouseY > j * 12
        ...
        if (model == gameCamera.aModel_423) {
          ...
          if (l2 == 1) {
            ...
            if (!showModCommands && selectedSpell >= 0) {
              ...
              if (!isOnFriendsList(playerArray[i2].name)) {
                ...
                menuText2[menuLength] = (new StringBuilder()).append("@whi@ ").append(playerArray[i2].name).append(s)
                    .toString();
            ...
            if (selectedSpell >= 0) {
              ...
              menuLength++;
              menuText1[menuLength] = "Examine";
              menuText2[menuLength] = "@lre@" + itemDef.getName() + (ourPlayer.admin >= 2 ? " @or1@("
                  + groundItemType[i2] + ":" + (groundItemX[i2] + areaX) + "," + (groundItemY[i2] + areaY) + ")" : "");
            ...
            if (selectedSpell >= 0) {
              ...
              menuText1[menuLength] = "Examine";
              menuText2[menuLength] = "@yel@" + npcDef.getName()
                  + (ourPlayer.admin >= 2 ? " @or1@(" + npcArray[i2].type + ")" : "");
          ...
          if (!aBooleanArray970[j2]) {
            if (selectedSpell >= 0) {
              ...
              menuText1[menuLength] = "Examine";
              menuText2[menuLength] = "@cya@" + EntityHandler.getDoorDef(i3).getName() + (ourPlayer.admin >= 2
                  ? " @or1@(" + i3 + ":" + (doorX[j2] + areaX) + "," + (doorY[j2] + areaY) + ")" : "");
          ...
          if (!aBooleanArray827[k2]) {
            if (selectedSpell >= 0) {
              ...
              menuText1[menuLength] = "Examine";
              menuText2[menuLength] = "@cya@" + EntityHandler.getObjectDef(j3).getName() + (ourPlayer.admin >= 2
                  ? " @or1@(" + j3 + ":" + (objectX[k2] + areaX) + "," + (objectY[k2] + areaY) + ")" : "");
  ...
  private final void drawFriendsWindow(boolean flag) {
    ...
    if (anInt981 == 0) {
      for (int i1 = 0; i1 < super.friendsCount; i1++) {
        ...
        friendsMenu.drawMenuListText(friendsMenuHandle, i1,
            s + DataOperations.longToString(super.friendsListLongs[i1]) + "~439~@whi@Remove         WWWWWWWWWW");
      }
    ...
    if (anInt981 == 1) {
      for (int j1 = 0; j1 < super.ignoreListCount; j1++)
        friendsMenu.drawMenuListText(friendsMenuHandle, j1,
            "@yel@" + DataOperations.longToString(super.ignoreListLongs[j1]) + "~439~@whi@Remove         WWWWWWWWWW");
    ...
    if (anInt981 == 0) {
      ...
      if (k1 >= 0 && super.mouseX < 489) {
        if (super.mouseX > 429)
          gameGraphics.drawText("Click to remove " + DataOperations.longToString(super.friendsListLongs[k1]), i + c / 2,
              j + 35, 1, 0xffffff);
        else if (super.friendsListOnlineStatus[k1] == 99)
          gameGraphics.drawText("Click to message " + DataOperations.longToString(super.friendsListLongs[k1]),
              i + c / 2, j + 35, 1, 0xffffff);
        else if (super.friendsListOnlineStatus[k1] > 0)
          gameGraphics.drawText(DataOperations.longToString(super.friendsListLongs[k1]) + " is on world "
              + super.friendsListOnlineStatus[k1], i + c / 2, j + 35, 1, 0xffffff);
        else
          gameGraphics.drawText(DataOperations.longToString(super.friendsListLongs[k1]) + " is offline", i + c / 2,
              j + 35, 1, 0xffffff);
      } else {
    ...
    if (anInt981 == 1) {
      ...
      if (l1 >= 0 && super.mouseX < 489 && super.mouseX > 429) {
        if (super.mouseX > 429)
          gameGraphics.drawText("Click to remove " + DataOperations.longToString(super.ignoreListLongs[l1]), i + c / 2,
              j + 35, 1, 0xffffff);
      } else {
    ...
    if (i >= 0 && j >= 0 && i < 196 && j < 182) {
      friendsMenu.updateActions(i + (((GameImage) (gameGraphics)).menuDefaultWidth - 199), j + 36,
      ...
      if (mouseButtonClick == 2 && showModCommands) {
        ...
        if (i2 >= 0 && super.mouseX <= 429 && super.friendsListOnlineStatus[i2] != 0) {
          ...
          menuWidth = gameGraphics.textWidth("Choose option", 1) + 5;
          for (int k1 = 0; k1 < menuLength; k1++) {
            int l1 = gameGraphics.textWidth(
                (new StringBuilder()).append(menuText1[k1]).append(" ").append(menuText2[k1]).toString(), 1) + 5;
            if (l1 > menuWidth) {
              menuWidth = l1;
            }
          }
  ...
  private final void drawMagicWindow(boolean flag) {
    ...
    if (menuMagicPrayersSelected == 0) {
      ...
      if (selectedSpellIndex != -1) {
        ...
        gameGraphics.drawString(EntityHandler.getSpellDef(selectedSpellIndex).getDescription(), i + 2, j + 136, 0,
            0xffffff);
        int i4 = 0;
    ...
    if (menuMagicPrayersSelected == 1) {
      ...
      for (int j2 = 0; j2 < EntityHandler.prayerCount(); j2++) {
        ...
        if (prayerOn[j2])
          s1 = "@gre@";
        spellMenu.drawMenuListText(spellMenuHandle, j1++, s1 + "Level " + EntityHandler.getPrayerDef(j2).getReqLevel()
      ...
      if (j3 != -1) {
        gameGraphics.drawText(
            "Level " + EntityHandler.getPrayerDef(j3).getReqLevel() + ": " + EntityHandler.getPrayerDef(j3).getName(),
            i + c / 2, j + 130, 1, 0xffff00);
    ...
    j = super.mouseY - 36;
    if (i >= 0 && j >= 0 && i < 196 && j < 182) {
      spellMenu.updateActions(i + (((GameImage) (gameGraphics)).menuDefaultWidth - 199), j + 36,
          super.lastMouseDownButton, super.mouseDownButton);
      if (j <= 24 && mouseButtonClick == 1)
    ...
    case 1018: // F11
      ...
      if (recording) {
        try {
          ...
          Recorder recorder = new Recorder(windowWidth, windowHeight + 11, Config.MOVIE_FPS, frames,
              file.getAbsolutePath(), "video.quicktime");
  ...
  private final void drawOptionsMenu(boolean flag) {
    ...
    if (i >= 0 && j >= 0 && i < 196 && j < 265) {
      ...
      j1 += 15;
      if (flag1)
        sendUpdatedPrivacyInfo(super.blockChatMessages, super.blockPrivateMessages, super.blockTradeRequests,
  ...
  private final void processGame() {
    ...
    for (int i = 0; i < playerCount; i++) {
      ...
      if (mob.waypointEndSprite != k) {
        ...
        if (j4 > 2)
          j5 = (j4 - 1) * 4;
        if (mob.waypointsX[l2] - mob.currentX > magicLoc * 3 || mob.waypointsY[l2] - mob.currentY > magicLoc * 3
            || mob.waypointsX[l2] - mob.currentX < -magicLoc * 3 || mob.waypointsY[l2] - mob.currentY < -magicLoc * 3
            || j4 > 8) {
    ...
    for (int j = 0; j < npcCount; j++) {
      ...
      if (mob_1.waypointEndSprite != j1) {
        ...
        if (k5 > 2)
          l5 = (k5 - 1) * 4;
        if (mob_1.waypointsX[k4] - mob_1.currentX > magicLoc * 3 || mob_1.waypointsY[k4] - mob_1.currentY > magicLoc * 3
            || mob_1.waypointsX[k4] - mob_1.currentX < -magicLoc * 3
            || mob_1.waypointsY[k4] - mob_1.currentY < -magicLoc * 3 || k5 > 8) {
  ...
  private final void drawDuelConfirmWindow() {
    ...
    gameGraphics.drawText("Please confirm your duel with @yel@" + DataOperations.longToString(duelOpponentNameLong),
  ...
  protected final void handleIncomingPacket(int command, int length, byte data[]) {
    try {
      ...
      if (command == 173) {
        ...
        // "+DataOperations.getUnsigned2Bytes(data, 1)+"\tTimes 32:
        // "+DataOperations.getUnsigned2Bytes(data, 1)*32);
        return;
      }
      if (command == 109) {
          ...
          if (DataOperations.getUnsignedByte(data[l1]) == 255) {
            ...
            for (int currentDoor = 0; currentDoor < doorCount; currentDoor++) {
              ...
              if (j27 != 0 || k31 != 0) {
                ...
                engineHandle.updateDoor(doorX[currentDoor], doorY[currentDoor], doorDirection[currentDoor],
          ...
          if (j28 == 1) {
            ...
            if (mob_2 != null) {
              ...
              if (k32 == ourPlayer.serverIndex)
                displayMessage("@yel@" + EntityHandler.getNpcDef(mob_2.type).getName() + ": " + mob_2.lastMessage, 5,
                    0);
            }
            i10 += byte9;
          } else if (j28 == 2) {
  ...
  private final void playSound(String s) {
    ...
    audioReader.loadData(sounds, DataOperations.method358(s + ".pcm", sounds),
  ...
  private final void drawTradeConfirmWindow() {
    ...
    gameGraphics.drawBoxAlpha(byte0, byte1 + 16, 468, 246, i, 160);
    gameGraphics.drawText(
        "Please confirm your trade with @yel@" + DataOperations.longToString(tradeConfirmOtherNameLong), byte0 + 234,
        byte1 + 12, 1, 0xffffff);
    ...
    gameGraphics.drawText("There is NO WAY to reverse a trade if you change your mind.", byte0 + 234, byte1 + 215, 1,
        0xffffff);
  ...
  private final void makeLoginMenus() {
    ...
    int i = 40;
    menuWelcome.drawText(256, 200 + i, "Welcome to Wolf Kingdom", 4, true);
    ...
    i = 230;
    menuNewUser.drawText(256, i + 8, "To create an account please go to the", 4, true);
    i += 20;
    menuNewUser.drawText(256, i + 8, "bathroom and stick your head in the toilet.", 4, true);
    i += 30;
  ...
  private final void drawInputBox() {
    ...
    if (inputBoxType == 2) {
      ...
      i += 20;
      gameGraphics.drawText("Enter message to send to " + DataOperations.longToString(privateMessageTarget), 256, i, 4,
          0xffffff);
      i += 20;
  ...
  private final void method119() {
      ...
      while (flag) {
        ...
        for (int i4 = 0; i4 < i; i4++)
          if (k1 + i3 > mobMessagesY[i4] - j && k1 - j < mobMessagesY[i4] + mobMessagesHeight[i4]
              && l - j2 < mobMessagesX[i4] + mobMessagesWidth[i4] && l + j2 > mobMessagesX[i4] - mobMessagesWidth[i4]
    ...
    for (int k = 0; k < anInt699; k++) {
      ...
      gameGraphics.spriteClip4(i1 - l4 / 2, (k4 + j4 / 2) - i5 / 2, l4, i5,
          EntityHandler.getItemDef(j3).getSprite() + SPRITE_ITEM_START, EntityHandler.getItemDef(j3).getPictureMask(),
          0, 0, false);
    }
  ...
  private final void drawMapMenu(boolean flag) {
    ...
    if (i >= 40 && i8 >= 0 && i < 196 && i8 < 152) {
      ...
      } else if (mouseButtonClick == 2 && showModCommands) {

        sendChatString((new StringBuilder()).append("teleport ").append(areaX + l2 / 128).append(" ")
            .append(areaY + j4 / 128).toString());
      }
    }
  }
  ...
  private final int characterTopBottomColours[] = { 0xff0000, 0xff8000, 0xffe000, 0xa0e000, 57344, 32768, 41088, 45311,
  ...
  private final int characterHairColours[] = { 0xffc030, 0xffa040, 0x805030, 0x604020, 0x303030, 0xff6020, 0xff4000,
  ...
  private int npcAnimationArray[][] = { { 11, 2, 9, 7, 1, 6, 10, 0, 5, 8, 3, 4 },
  ...
  private final String skillArray[] = { "Attack", "Defense", "Strength", "Hits", "Ranged", "Prayer", "Magic", "Cooking",
