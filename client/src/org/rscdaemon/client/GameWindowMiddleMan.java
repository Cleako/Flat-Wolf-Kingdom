...
public abstract class GameWindowMiddleMan extends GameWindow {
  ...
  protected final void login(String user, String pass, boolean reconnecting) {
    if (socketTimeout > 0) {
      loginScreenPrint("Please Wait...", "Connecting to Wolf Kingdom...");
      try {
        Thread.sleep(2000L);
      }
      catch (Exception _ex) {
  ...
  protected final void sendUpdatedPrivacyInfo(int chatMessages, int privateMessages, int tradeRequests,
      int duelRequests) {
